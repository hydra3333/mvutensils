...
* Super:
    ...
    * The levels argument has now been changed to alllevels=True/False (default True), note that Analyse is the only filter that uses the additional levels generated by alllevels=True, you can still limit the used number of levels in Analyse
